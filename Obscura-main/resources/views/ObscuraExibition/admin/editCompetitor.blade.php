            ...
            <div id="modal-add" class="modal-dialog row" style="width:100%;margin-top:50px;">	
                <div class="modal-content p-4 col-md-12">
                    <div class="modal-header d-flex justify-content-center">
                        <span class="font-goudy font-yellow fw-bold">Edit</span><span class="ms-2 font-goudy fw-bold font-yellow">Competitor</span>
                    </div>
                    <div class="modal-body">
                    @if(Auth()->user()->role == 'admin')
                    <form method="POST" action="{{ url('obscura-exhibition/edit-competitor/edit') }}" enctype="multipart/form-data">
                    ...
                    @endif
                        ...
                        <div class="form-group row flex-column">
                            ...
                            <div class="col-md-12">
                                <input id="name" type="text" value="{{ $gallery['name'] }}" class="form-control" name="name" >
                            </div>
                        ...
                        <div class="form-group row flex-column ">
                            ...
                            <div class="col-md-12">
                                <input id="title" type="text" value="{{ $gallery['title'] }}" class="form-control" name="title" >
                            </div>
                            @error('title')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group row flex-column p-2">
                            ...
                            <textarea name="description" id="description" rows="5" placeholder="Description">{{ $gallery['description'] }}</textarea>
